...
namespace VoxelImporter
{
    public class VoxelObjectCore : VoxelBaseCore
    {
        ...
        public virtual List<UnityEngine.Material> materials { get { return voxelObject.materials; } set { voxelObject.materials = value; } }
        ...
        protected override bool CreateMesh()
        {
            ...
            DisplayProgressBar("");
            {
                ...
                for (int i = 0; i < materials.Count; i++)
                {
                    ...
                    {
                        var tmp = UnityEngine.Material.Instantiate(materials[i]);
        ...
        public override void SetRendererCompornent()
        {
            ...
            if (voxelBase.updateMeshRendererMaterials)
            {
                ...
                if (materials != null)
                {
                    UnityEngine.Material[] tmps = new UnityEngine.Material[voxelBase.materialIndexes.Count];
