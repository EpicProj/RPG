...
namespace VoxelImporter
{
    public class VoxelEditorCommon
    {
        ...
        public UnityEngine.Material vertexColorMaterial { get; private set; }
        public UnityEngine.Material vertexColorTransparentMaterial { get; private set; }
        public UnityEngine.Material vertexColorTransparentZwriteMaterial { get; private set; }
        public UnityEngine.Material unlitColorMaterial { get; private set; }
        public UnityEngine.Material unlitTextureMaterial { get; private set; }
        ...
        public VoxelEditorCommon(VoxelBase objectTarget, VoxelBaseCore objectCore)
        {
            ...
            vertexColorMaterial = new UnityEngine.Material(Shader.Find("Voxel Importer/VertexColor"));
            vertexColorMaterial.hideFlags = HideFlags.DontSave;

            vertexColorTransparentMaterial = new UnityEngine.Material(Shader.Find("Voxel Importer/VertexColor-Transparent"));
            vertexColorTransparentMaterial.hideFlags = HideFlags.DontSave;

            vertexColorTransparentZwriteMaterial = new UnityEngine.Material(Shader.Find("Voxel Importer/VertexColor-Transparent-Zwrite"));
            vertexColorTransparentZwriteMaterial.hideFlags = HideFlags.DontSave;

            unlitColorMaterial = new UnityEngine.Material(Shader.Find("Voxel Importer/Unlit/Color"));
            unlitColorMaterial.hideFlags = HideFlags.DontSave;

            unlitTextureMaterial = new UnityEngine.Material(Shader.Find("Voxel Importer/Unlit/Transparent"));
        ...
        public void CreateIconObject(Transform transform = null, Mesh mesh = null, UnityEngine.Material[] materials = null)
        {
