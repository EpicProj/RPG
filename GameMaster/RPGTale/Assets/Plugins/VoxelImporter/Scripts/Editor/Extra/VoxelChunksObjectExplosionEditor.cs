                                        ...
                                        if (GUILayout.Button("Save", GUILayout.Width(48), GUILayout.Height(16)))
                                        {
                                            ...
                                            if (!string.IsNullOrEmpty(path))
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    AssetDatabase.CreateAsset(UnityEngine.Material.Instantiate(explosionObject.materials[i]), path);
                                                    explosionObject.materials[i] = AssetDatabase.LoadAssetAtPath<UnityEngine.Material>(path);
            ...
            if (explosionObject.materialMode == VoxelChunksObject.MaterialMode.Combine)
            {
                ...
                if (explosionObject.materials != null)
                {
                    for (int index = 0; index < explosionObject.materials.Count; index++)
                    {
                        ...
                        path = FileUtil.GetProjectRelativePath(path);
                        AssetDatabase.CreateAsset(UnityEngine.Material.Instantiate(explosionObject.materials[index]), path);
                        explosionObject.materials[index] = AssetDatabase.LoadAssetAtPath<UnityEngine.Material>(path);
                    }
                }
                #endregion
                    ...
                    for (int i = 0; i < explosionObject.chunksExplosion.Length; i++)
                    {
                        ...
                        if (explosionObject.chunksExplosion[i].materials != null)
                        {
                            for (int index = 0; index < explosionObject.chunksExplosion[i].materials.Count; index++)
                            {
                                ...
                                path = FileUtil.GetProjectRelativePath(path);
                                AssetDatabase.CreateAsset(UnityEngine.Material.Instantiate(explosionObject.chunksExplosion[i].materials[index]), path);
                                explosionObject.chunksExplosion[i].materials[index] = AssetDatabase.LoadAssetAtPath<UnityEngine.Material>(path);
                            }
                        }
                        #endregion
                    }
