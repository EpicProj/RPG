    ...
    public class DaeExporter
    {
        ...
        public bool Export(string path, List<Transform> transforms, AnimationClip[] clips = null)
        {
            ...
            try
            {
                ...
                Func<Transform, UnityEngine.Material[]> MaterialsFromTransform = (t) =>
                {
                    #region SkinnedMeshRenderer
                    {
                        var skinnedMeshRenderer = t.GetComponent<SkinnedMeshRenderer>();
                ...
                Action<Action<Transform, Mesh, UnityEngine.Material[]>> MakeFromTransform = (action) =>
                {
                    foreach (var t in transforms)
                    {
                ...
                #region Effects
                var effectsDic = new Dictionary<UnityEngine.Material, Grendgine_Collada_Effect>();
                if (settings_exportMesh)
                {
                ...
                #region Materials
                var materialsDic = new Dictionary<UnityEngine.Material, Grendgine_Collada_Material>();
                if (settings_exportMesh)
                {
