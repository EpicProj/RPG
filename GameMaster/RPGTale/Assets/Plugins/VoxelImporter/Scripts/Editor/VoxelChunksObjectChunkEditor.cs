                                    ...
                                    if (GUILayout.Button("Save", GUILayout.Width(48), GUILayout.Height(16)))
                                    {
                                        ...
                                        if (!string.IsNullOrEmpty(path))
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                path = FileUtil.GetProjectRelativePath(path);
                                                AssetDatabase.CreateAsset(UnityEngine.Material.Instantiate(chunkTarget.materials[i]), path);
                                                chunkTarget.materials[i] = AssetDatabase.LoadAssetAtPath<UnityEngine.Material>(path);
                                                Refresh();
                                            }
                                        }
